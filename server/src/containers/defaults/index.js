...
const Defaults = () => {
  ...
  const [addFiled, setAddFiled] = useState([defaultFilters[0].name]);
    ...
    <div>
      ...
      <div className="common-container">
        ...
        <div className={`common-wrapper ${show ? 'active' : ''} `}>
          ...
          <div className="dashboard-disburment-card row">
            <div className="col-lg-4 col-md-6 col-sm-12 mpad default-progress">
              <ProgressBar
                percent="50"
                amount="67,36,723.34"
                text="Total Principal Outstanding of bounced payments"
                disbursement="22.2% more principal"
                color="blue-color"
                disbursementLabel="For number of"
                disbursementSpan="1,133"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 mpad default-progress">
              <ProgressBar
                ...
                disburment="22.2% more disburment"
                color="green-color"
                disbursementLabel="Bounced / Total users"
                disbursementSpan="1,133"
                disbursementLabelText=""
                disbursementSpanText=""
              />
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 mpad default-progress">
              <ProgressBar
                ...
                color="red-color"
                disbursementLabel="For"
                disbursementSpan="1133 / 6028"
                disbursementLabelText=""
                disbursementSpanText=""
              />
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 mpad">
              <ProgressBar
                ...
                disbursement="27.1% more default customer"
                color="yellow-color"
                disbursementLabel="For"
                disbursementSpan="617 / 2022"
                disbursementLabelText=""
                disbursementSpanText=""
              />
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 mpad">
              <ProgressBar
                ...
                rate="11.87%"
                text="90-179 days"
                disbursement="22.5% more"
                color="dark-blue-color"
                disbursementLabel="For"
                disbursementSpan="216 / 1454"
                disbursementLabelText=""
                disbursementSpanText=""
              />
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 mpad">
              <ProgressBar
                ...
                rate="6.22%"
                text="180 plus days"
                disbursement="15% more"
                color="ocean-blue-color"
                disbursementLabel="For"
                disbursementSpan="86 / 1454"
                disbursementLabelText=""
                disbursementSpanText=""
              />
            </div>
          ...
          <div className="today-emi-sec">
            <DataTable
              ...
              downloadPopupClass="default-download-popup"
              ...
              setExecutePayment={setExecutePayment}
            />
            {/* <div className="col-md-12 mpad">
